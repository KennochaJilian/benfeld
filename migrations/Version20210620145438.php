 ...
 */
final class Version20210620145438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, room_id INT NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, status enum(\'pending\', \'validated\', \'refused\', \'cancelled\', \'passed\'), created_at DATETIME NOT NULL, cancelling_reason LONGTEXT DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_E00CEDDEA76ED395 (user_id), INDEX IDX_E00CEDDE54177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
